...
public class TaskC  {
	...
	public void method3(Work work, @Taskparam("name") String x, @Taskparam(require = false) Date birth) {
		System.out.println("TaskC's method3 be invoked !!! x : "+x+" , birth : "+birth+" , extra : "+work.getWorkContext().getRuntimeArgs());
		work.getWorkContext().setResult("RESULT");
	}

	public void methodEnd(Work work) {
		System.out.println("TaskC's methodEnd be invoked !!! birth : "+work.getContext("birth"));
